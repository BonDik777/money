...
class Main(tk.Frame):
    ...
    def init_main(self):
        ...
        btn_open_dialog = tk.Button(toolbar, text='Добавити', command=self.open_dialog, bg='#d7d8e0', bd=0,
        ...
        self.tree.heading('description', text='Значення')
        self.tree.heading('costs', text='Доходи/витрати')
...
class Child(tk.Toplevel):
    ...
    def init_child(self):
        ...
        label_description = tk.Label(self, text='Значення:')
        label_description.place(x=50, y=50)
        label_select = tk.Label(self, text='Доходи/витрати:')
        ...
        self.combobox = ttk.Combobox(self, values=[u'Дохід', u'Витрати'])
